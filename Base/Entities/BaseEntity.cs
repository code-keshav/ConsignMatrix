...
public class BaseEntity : IBaseEntity
{
    ...
    public char RecStatus { get; set; } = RecStatusConstants.Active;
    public bool IsActive() => Status == StatusEnum.Active;
    
    public void MarkAsActive() => Status = StatusEnum.Active;
    public void MarkAsInactive() => Status = StatusEnum.Inactive;
}
